...
public class JDialogClientes extends javax.swing.JDialog {
     ...
     */
    public void rellenarListaCliente() {
    ...
    public ArrayList<Coche> llenarTabla(){
        ArrayList<Coche> lista2 = new ArrayList<>();
        for (Cliente cliente : lista) {
            Coche coche = new Coche(cliente.getModelo(),cliente.getModelo(),cliente.getMatricula());
           lista2.add(coche);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        for (int i = 0; i < lista.size(); i++) {
            if (lista.get(i).getMatricula().equals(jTextFieldMatricula.getText())) {
                lista.remove(i);
                encontrado = true;
            }
